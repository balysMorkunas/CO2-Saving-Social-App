...
class PersonTest{
    ...
    Person testPerson1 = new Person(1,"test@hotmail.com","Dwight","Schrute", "123", 500);

    @org.junit.jupiter.api.Test
    void getId() {
        Assertions.assertEquals(1, testPerson.getId());
    }

    @org.junit.jupiter.api.Test
    void setId() {
        testPerson.setId(2);
        Assertions.assertEquals(2, testPerson.getId());
    }

    @org.junit.jupiter.api.Test
    void getFirstName() {
        Assertions.assertEquals("Dwight", testPerson.getFirstName());
    }

    @org.junit.jupiter.api.Test
    void setFirstName() {
        testPerson.setFirstName("Jim");
        Assertions.assertEquals("Jim", testPerson.getFirstName());
    }

    @org.junit.jupiter.api.Test
    void getLastName() {
        Assertions.assertEquals("Schrute", testPerson.getLastName());
    }

    @org.junit.jupiter.api.Test
    void setLastName() {
        testPerson.setLastName("Halpert");
        Assertions.assertEquals("Halpert", testPerson.getLastName());
    }

    @org.junit.jupiter.api.Test
    void getPassword() {
        Assertions.assertEquals("123", testPerson.getPassword());
    }

    @org.junit.jupiter.api.Test
    void setPassword() {
        testPerson.setPassword("321");
        Assertions.assertEquals("321", testPerson.getPassword());
    }

    @org.junit.jupiter.api.Test
    void getPoints() {
        Assertions.assertEquals(1000, testPerson.getPoints());
    }

    @org.junit.jupiter.api.Test
    void setPoints() {
        testPerson.setPoints(2000);
        Assertions.assertEquals(2000, testPerson.getPoints());

    }

    @org.junit.jupiter.api.Test
    void getImage() {
        Assertions.assertEquals(null, testPerson.getImage());
    }

    @org.junit.jupiter.api.Test
    void setImage() {
        testPerson.setImage("Image");
        Assertions.assertEquals("Image", testPerson.getImage());

    }

    @org.junit.jupiter.api.Test
    void getEmail() {
        assertEquals("test@hotmail.com",testPerson.getEmail());
    }
    ...
    void getToString() {
        ...
        assertTrue(toString.contains("points=" + 1000));
    ...
    @org.junit.jupiter.api.Test
    void getHidden() {
        testPerson.setHidden(false);
        assertFalse(testPerson.getHidden());
    }

    @org.junit.jupiter.api.Test
    void setHidden() {
        testPerson.setHidden(true);
        testPerson.setHidden(false);
        assertFalse(testPerson.getHidden());
    }
    ...
    void getRealImage() {
        ...
        testPerson.setImage(image);
        File file = testPerson.getRealImage();

        new File(System.getProperty("user.home") + "\\test\\").mkdirs();
        File file2 = new File(System.getProperty("user.home") + "\\test\\", 1 + ".jpg");
    ...
    @org.junit.jupiter.api.Test
    void compare() {
        int result = testPerson2.pointComparator.compare(testPerson1, testPerson);
